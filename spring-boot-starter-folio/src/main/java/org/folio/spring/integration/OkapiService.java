...
public class OkapiService {
  ...
  public Map<String, Collection<String>> getOkapiHeaders() {
    return Optional.ofNullable(RequestContextHolder.getRequestAttributes())
        .map(e -> getHeadersFromRequest())
        .orElseGet(asyncService.getRequestContext().get()::getHeaders);
  }
  ...
  public Optional<String> getUsername() {
    return parseTokenPayload(RequestUtils.getHttpServletRequest().getHeader(XOkapiHeaders.TOKEN))
